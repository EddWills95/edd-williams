...
<section class="base-section justify-start">
	<h2 class="text-2xl mb-1">Home Lab</h2>
	<p class="text-light-cyan/60 text-base mb-8">
		Alongside the day job, I run a small home lab — solar, battery storage, and a pile of
		self-hosted services. These numbers are pulled live from the same Home Assistant setup that runs
		my house.
	</p>
	...
	{:else}
		<div bind:this={diagramContainer} class="relative w-full py-8">
			...
			<div class="flex flex-col items-center gap-12 sm:flex-row sm:justify-between sm:items-center">
				<!-- Solar node -->
