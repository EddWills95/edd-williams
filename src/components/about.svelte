<div class="flex flex-col flex-wrap justify-center items-center gap-4 sm:flex-row">
	<article class="flex flex-col gap-4 leading-relaxed">
		<p class="relative">
			Hey 👋 I'm Edd and I've been messing with technology for as long as I can remember and since
			2017, have been professionally. I started with <span class="italic text-burnt-sienna-400"
				>javascript animations</span
			>
		...
		<p class="relative">
			With an education in politics, I come at software from a slightly different angle. I love
